...
namespace Business.Concrete
{
	public class BaBsRecoinciliationManager : IBaBsReconciliationService
	{
		...
		public BaBsRecoinciliationManager(IBaBsRecoinciliationDal baBsRecoinciliationDal, ICurrencyAccountService currencyAccountService, IMailTemplateService mailTemplateService, IMailParameterService mailParameterService, IMailService mailService)
		{
		...
		public IResult SendReconciliationMail(BaBsReconciliationDto babsReconciliationDto)
		{
			...
			string link = "https://localhost:7150/api/BaBsReconciliations/GetByCode?code=" + babsReconciliationDto.Guid;
